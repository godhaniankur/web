                ...
                <div className=' relative w-11/12 flex flex-col lg:flex-row mx-auto gap-x-10'>
                    <form className='w-full flex flex-col gap-y-2'>
                            ...
                            <label>
                                ...
                                <input type="tel" placeholder='Enter Your Email address' className='w-full p-1.5 rounded-md outline-none'/>
                            </label>
                            <label>
                    ...
                    <div className='mb-10 flex  flex-col lg:flex-row-reverse w-full'>
